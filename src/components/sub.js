...
/* ---------- Icons (brand-colored, purge-safe) ---------- */
const CheckIcon = () => (
  <svg className="w-6 h-6 text-amber-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
  </svg>
);

const FreshnessIcon = () => (
  <svg className="w-12 h-12 text-amber-500 mb-4 mx-auto transition-transform duration-500 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
const FlexibilityIcon = () => (
  <svg className="w-12 h-12 text-amber-500 mb-4 mx-auto transition-transform duration-500 group-hover:scale-110 group-hover:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
const ClockIcon = () => (
  <svg className="w-8 h-8 text-amber-500 transition-transform duration-300 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
  </svg>
);

const CalendarIcon = () => (
  <svg className="w-8 h-8 text-amber-500 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Choose your perfect monthly milk plan from Agasthya. Pure, fresh, and delivered to your doorstep."
        />
      </Head>
              ...
              <div className="max-w-4xl mx-auto mb-8 bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div className="text-left text-sm">
                    <p className="font-semibold text-amber-900">Now Delivering In:</p>
                    <p className="text-amber-800">Jubilee Hills, Manikonda, Narsing, Chitrapuri, & OU Colony.</p>
                    <p className="text-xs text-amber-700 mt-1">The app will confirm availability for your specific address.</p>
                  </div>
                </div>
              </div>
