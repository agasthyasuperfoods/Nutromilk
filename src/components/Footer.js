...
//         {/* Adjusted grid from 4 cols to 3 for a balanced look */}
//         <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-y-10 gap-x-8 px-6 lg:px-8 items-start">
...
//         <p>© {new Date().getFullYear()} Agasthya Nutro Milk Pvt. Ltd. All rights reserved.</p>
//       </div>
//     </footer>
//   );
// }
              ...
              <ul className="mt-4 space-y-3 text-sm">
                ...
                <li className="flex items-center gap-2 text-slate-700">
                  ...
                  <div className="space-x-2">
                    ...
                    <span>•</span>
                    <a href="tel:+918712008651" className="hover:text-amber-700">+91 87120 08651</a>
                  </div>
                </li>
                <li className="flex items-center gap-2 text-slate-700">
